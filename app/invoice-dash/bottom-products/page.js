...
export default function BottomProducts() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/products?year=${year}&month=${month}`)
      ...
      .then((d) => {
        ...
        arr.sort((a, b) => (a.total_sales || 0) - (b.total_sales || 0));
  ...
  if (loading) return <div className="loading">Loading Bottom Products...</div>;

  return (
    <div>
      <div className="page-header">
        <h1>Bottom 10 Product Lines</h1>
      ...
      <ChartContainer title="Bottom 10 Product Lines by Sales">
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={products} layout="vertical" margin={{ left: 120 }}>
            ...
            <Bar dataKey="total_sales" fill="#f44336" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </ChartContainer>
